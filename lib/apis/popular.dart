...
final getproviderofpopular=ChangeNotifierProvider.autoDispose<popular>((ref)=>popular());
class  popular extends ChangeNotifier{
  ...
  Future getdata() async{
    ...
    try{
      ...
      var url =Uri.parse("https://api.themoviedb.org/3/movie/popular?api_key=${Api_Key}&language=en-US&page=1");
      print("hna url");
